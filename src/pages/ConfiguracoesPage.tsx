...
import { Plus, Search, Upload, Settings, Pencil, Trash2, Users, X } from 'lucide-react'
...
import { IndicadorCatalogoDialog } from '@/features/indicadores/IndicadorCatalogoDialog'
...
export function ConfiguracoesPage() {
  const { indicadores, loading, createIndicador, updateIndicador, deleteIndicador, upsertManyByCodigo, updateManyIndicadores } =
    useIndicadores()
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-navy-700/70">
            Cadastro dos indicadores GRI: código, título, cronograma e perguntas do relatório.
          </p>
        </div>
      ...
      {semDados ? (
        <EmptyState
          ...
          description="Importe a planilha de indicadores GRI (com área, respondente e data de entrega) ou cadastre um indicador manualmente."
          action={
            <div className="flex gap-2">
              <Button variant="outline" onClick={() => setImportOpen(true)}>
                <Upload size={16} /> Importar planilha
